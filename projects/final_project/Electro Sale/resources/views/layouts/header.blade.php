<header class="header_section">
    <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
            <a class="navbar-brand" href="{{route('home')}}"><img width="250" src="{{asset('assets/images/logo.png')}}"
                    alt="#" /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown {{ in_array(Route::currentRouteName(), ['about', 'testimonial']) ? 'active' : '' }}">
